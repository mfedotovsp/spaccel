...
$(body).on('beforeSubmit', '#create-message-expert', function (e) {
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            if (response.sender === 'expert') $(conversation_list_menu).find('.containerForAllAdminsConversations').html(response.conversationsAdminForExpertAjax);
            else if (response.sender === 'admin') $(conversation_list_menu).find('.containerForExpertConversations').html(response.conversationsExpertForAdminAjax);
