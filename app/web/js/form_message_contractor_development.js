...
$(body).on('beforeSubmit', '#create-message-development', function (e) {
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            if (response.sender === 'contractor') $(conversation_list_menu).find(response.blockConversationDevelopment).html(response.conversationDevelopmentForContractorAjax);
...
$(body).on('input', 'textarea#input_send_message', function () {
    ...
    var url = '/contractor/message/save-cache-message-development-form?id=' + conversation_id;
...
$(body).on('click', '.pagination-messages .messages-pagination-list li.next a', function(e){
    ...
    var url = '/contractor/message/get-page-message-development?id=' + conversation_id + '&page=' + next_page + '&final=' + idFirstMessagePreviosPage;
...
setInterval(function(){
    ...
    var url = '/contractor/message/check-new-messages-development?id=' + conversation_id + '&idLastMessageOnPage=' + idLastMessage;
