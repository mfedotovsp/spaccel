...
$(body).on('beforeSubmit', '#create-message-expert', function (e) {
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            if (response.sender === 'expert') $(conversation_list_menu).find(response.blockConversationAdminMain).html(response.conversationAdminMainForExpertAjax);
            else if (response.sender === 'main_admin') $(conversation_list_menu).find('.containerForExpertConversations').html(response.conversationsExpertForAdminMainAjax);
            ...
            else if (response.sender === 'expert')
...
$(body).on('input', 'textarea#input_send_message', function () {
    ...
    var url = '/expert/message/save-cache-message-expert-form?id=' + conversation_id;
...
$(body).on('click', '.pagination-messages .messages-pagination-list li.next a', function(e){
    ...
    var url = '/expert/message/get-page-message?id=' + conversation_id + '&page=' + next_page + '&final=' + idFirstMessagePreviosPage;
...
setInterval(function(){
    ...
    var url = '/expert/message/check-new-messages-expert?id=' + conversation_id + '&idLastMessageOnPage=' + idLastMessage;
