...
$(body).on('click', '.showRespondUpdateForm', function(e){
    ...
    if (!isContractorModule) {
        if (action !== 'view-trash') {
            ...
            var url = '/responds/get-data-update-form?stage=6&id=' + id + '&isOnlyNotDelete=false';
        }
    } else {
        $('#formUpdateRespond').remove();
        if (action !== 'view-trash') {
            var url = '/contractor/responds/get-data-update-form?stage=6&id=' + id;
        } else {
            var url = '/contractor/responds/get-data-update-form?stage=6&id=' + id + '&isOnlyNotDelete=false';
        }
    }
...
$(body).on('click', '.showDescInterviewUpdateForm', function(e){
    ...
    if (action !== 'view-trash') {
        ...
        var url = '/interviews/get-data-update-form?stage=6&id=' + id + '&isOnlyNotDelete=false';
    }
