...
setInterval(function(){
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            $(conversation_list_menu).find(response.blockConversationDevelopment).html(response.conversationDevelopmentForContractorAjax);
    ...
    // Проверяем прочитал ли проектант сообщения
