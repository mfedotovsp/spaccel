...
$(body).on('beforeSubmit', '#create-message-expert', function (e) {
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            if (response.sender === 'user') $(conversation_list_menu).find('.containerExpertConversations').html(response.conversationsExpertForUser);
            else if (response.sender === 'expert') $(conversation_list_menu).find('.containerForAllUsersConversations').html(response.conversationsUserForExpertAjax);
...
$(body).on('input', 'textarea#input_send_message', function () {
    ...
    var url = '/message/save-cache-message-expert-form?id=' + conversation_id;
...
$(body).on('click', '.pagination-messages .messages-pagination-list li.next a', function(e){
    ...
    var url = '/message/get-page-message-expert?id=' + conversation_id + '&page=' + next_page + '&final=' + idFirstMessagePreviosPage;
...
setInterval(function(){
    ...
    var url = '/message/check-new-messages-expert?id=' + conversation_id + '&idLastMessageOnPage=' + idLastMessage;
