...
';
    ...
    private function getDataStringProject(Projects $project): string
    {
        $dataProject = [
            ...
            'Результат интеллектуальной деятельности' => $project->rid ?: '',
            'Суть результата интеллектуальной деятельности' => $project->core_rid ?: '',
            'Наименование патента' => $project->patent_name ?: '',
            'Номер патента' => $project->patent_number ?: '',
            ...
            'На какой технологии основан проект' => $project->technology ?: '',
            'Макет базовой технологии' => $project->layout_technology ?: '',
            'Зарегистрированное юр. лицо' => $project->register_name ?: '',
            'Дата регистрации' => $project->getRegisterDate() ? date('d.m.Y', $project->getRegisterDate()) : '',
            'Адрес сайта' => $project->site ?: '',
            'Инвестор' => $project->invest_name ?: '',
            ...
            'Мероприятие, на котором проект анонсирован впервые' => $project->announcement_event ?: '',
