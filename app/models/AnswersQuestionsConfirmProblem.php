 ...
 * интервью на этапе подтверждения гипотезы проблемы
 *
 * Class AnswersQuestionsConfirmProblem
 * @package app\models
 *
 * @property int $id                                            Идентификатор записи в таб. answers_questions_confirm_problem
