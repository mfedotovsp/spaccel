...
/**
 * Класс, который хранит сообщения из бесед техподдержки со всеми остальными пользователями
 *
 ...
 *
 * @property ConversationDevelopment $conversation              Беседа
...
class MessageDevelopment extends ActiveRecord
{
    ...
    /**
     * Получить дату отправления сообщения
