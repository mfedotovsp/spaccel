...
Modal::begin([
    ...
    'footer' => '<div class="text-center">'.
        ...
        Html::a('Ок', ['/confirm-mvp/not-exist-confirm', 'id' => $model->getId()],[
            'class' => 'btn btn-default',
            'style' => ['width' => '120px'],
...
<h4 class="text-center">
    Вы не набрали достаточное количество респондентов, которые подтвердили продукт(MVP). Следующий этап будет не доступен.
    После завершения подтверждения продукта(MVP) будет разрешена экспертиза и запрещено редактирование данной сущности.
    Завершить подтверждение продукта(MVP) и вернуться к разработке MVP?
</h4>
...
Modal::begin([
    ...
    'footer' => '<div class="text-center">'.
        ...
        Html::a('Ок', ['/confirm-mvp/exist-confirm', 'id' => $model->getId()],[
            'class' => 'btn btn-default',
            'style' => ['width' => '120px'],
            'id' => 'exist-confirm',
        ]).
...
<h4 class="text-center">
    После завершения подтверждения продукта(MVP) будет разрешена экспертиза и запрещено редактирование данной сущности.
    Завершить подтверждение продукта(MVP) и перейти к генерации бизнес-модели?
</h4>
...
Modal::begin([
    ...
    'header' => Html::a('<div style="margin-top: -15px;">Ответы респондентов на вопросы интервью' . Html::img('/images/icons/icon_export.png', ['style' => ['width' => '22px', 'margin-left' => '10px', 'margin-bottom' => '10px']]) . '</div>', [
        '/confirm-mvp/mpdf-questions-and-answers', 'id' => $model->getId()], [
        'class' => 'export_link',
        'target' => '_blank',
        'title' => 'Скачать в pdf',
    ]),
