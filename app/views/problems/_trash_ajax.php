                ...
                <div class="row pull-right" style="padding-right: 10px; display:flex; align-items: center;">
                    <div style="margin-right: 25px;">
                        ...
                        <?php if ($confirm) : ?>
                            ...
                            <?= Html::a('Далее', ['/confirm-problem/view-trash', 'id' => $confirm->getId()], [
                    ...
                    <div>
                        ...
                        <?php if (User::isUserSimple(Yii::$app->user->identity['username'])) : ?>
                            ...
                            <?= Html::a(Html::img('/images/icons/recovery_icon.png', ['style' => ['width' => '24px']]),
                                ['/problems/recovery', 'id' => $model->getId()], [
                                    'title' => 'Восстановить'
                                ]) ?>
        ...
        <div class="row container-one_hypothesis_mobile row_hypothesis-<?= $model->getId() ?>">
            ...
            <?php if (User::isUserSimple(Yii::$app->user->identity['username'])) : ?>
                ...
                <div class="hypothesis_buttons_mobile">
                    ...
                    <?= Html::a('Восстановить проблему', ['/problems/recovery', 'id' => $model->getId()], [
                        'class' => 'btn btn-default',
                        'style' => [
                            'display' => 'flex',
                            'width' => '47%',
                ...
                <div class="hypothesis_buttons_mobile">
                    ...
                    <?php if ($confirm && $model->getEnableExpertise() === EnableExpertise::ON) : ?>
                        ...
                        <?= Html::a('Работать далее', Url::to(['/confirm-problem/view-trash', 'id' => $confirm->getId()]), [
                            'class' => 'btn btn-default',
                            'style' => [
                                'display' => 'flex',
                                'width' => '96%',
...
<div class="mt-15" style="display: flex; justify-content: center;">
    <?= Html::a('Вернуться к списку', ['/problems/list', 'id' => $basicConfirmId],[
        'id' => 'show_list',
        'class' => 'btn btn-default',
        'style' => [
            'display' => 'flex',
