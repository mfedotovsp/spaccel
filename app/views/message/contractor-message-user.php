...
/**
 * @var ConversationContractor $conversation
 * @var ConversationAdmin $adminConversation
 * @var User $admin
 * @var FormCreateMessageContractor $formMessage
 * @var User $user
 * @var User $contractor
            ...
            <div id="conversation-list-menu">
                ...
                <div class="containerContractorConversations">
                    ...
                    <?php if ($contractorConversations) : ?>
                        ...
                        <?php foreach ($contractorConversations as $conversation) : ?>

                            <?php if ($conversation->getContractorId() === $contractor->getId()) : ?>

                                <div class="container-user_messages active-message" id="contractorConversation-<?= $conversation->getId() ?>">
                ...
                <?php if ($messages) : ?>
                    ...
                    <div class="create-message">
                        ...
                        $form = ActiveForm::begin([
                            'id' => 'create-message-contractor',
                            'action' => Url::to(['/message/send-message-contractor', 'id' => Yii::$app->request->get('id')]),
...
<?php $this->registerJsFile('@web/js/contractor_message_user_contractor.js'); ?>
<?php $this->registerJsFile('@web/js/form_message_contractor_user.js'); ?>
