                    ...
                    <?php if ($allConversations) : ?>
                        ...
                        <?php foreach ($allConversations as $oneConversation) : ?>
                            ...
                            <?php if (User::isUserSimple($oneConversation->user->getUsername())) : ?>
                                ...
                                <?php if ($oneConversation->getUserId() !== $user->getId()) : ?>

                                    <div class="container-user_messages" id="conversation-<?= $oneConversation->getId() ?>">

                                        <!--Проверка существования аватарки-->
                                        <?php if ($oneConversation->user->getAvatarImage()) : ?>
                                            <?= Html::img('@web/upload/user-'.$oneConversation->user->getId().'/avatar/'.$oneConversation->user->getAvatarImage(), ['class' => 'user_picture']) ?>
                                        <?php else : ?>
                                ...
                                <?php else : ?>
                                    ...
                                    <div class="container-user_messages active-message" id="conversation-<?= $oneConversation->getId() ?>">
