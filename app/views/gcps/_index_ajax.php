                        ...
                        <?php else : ?>
                            ...
                            <?php if (User::isUserSimple(Yii::$app->user->identity['username'])) : ?>
                                ...
                                <?php elseif ($model->getEnableExpertise() === EnableExpertise::ON) : ?>
                                    ...
                                    <?= Html::a('Подтвердить', ['#'], [
                                        'id' => 'choosing_confirmation_option-gcp-' . $model->getId(),
        ...
        <div class="row container-one_hypothesis_mobile row_hypothesis-<?= $model->getId() ?>">
            ...
            <?php if (User::isUserSimple(Yii::$app->user->identity['username'])) : ?>
                ...
                <div class="hypothesis_buttons_mobile">
                    ...
                    <?= Html::a('Редактировать', ['/gcps/get-hypothesis-to-update', 'id' => $model->getId()], [
                    ...
                    <?php if ($model->getEnableExpertise() === EnableExpertise::OFF) : ?>
                        ...
                        <?= Html::a('Запросить экспертизу', ['/gcps/enable-expertise', 'id' => $model->getId()], [
                    ...
                    <?php elseif ($model->getEnableExpertise() === EnableExpertise::ON) : ?>
                        ...
                        <?= Html::a('Смотреть экспертизу', ['/expertise/get-list', 'stage' => StageExpertise::getList()[StageExpertise::GCP], 'stageId' => $model->getId()], [
                ...
                <div class="hypothesis_buttons_mobile">
                    ...
                    <?= Html::a('Удалить ЦП', ['/gcps/delete', 'id' => $model->getId()], [
                    ...
                    <?php elseif ($model->getEnableExpertise() === EnableExpertise::ON) : ?>
                        ...
                        <?= Html::a('Работать далее', Url::to(['/confirm-gcp/create', 'id' => $model->getId()]), [
                            'class' => 'btn btn-default',
                            'style' => [
                                'display' => 'flex',
                                'width' => '47%',
            ...
            <?php elseif (User::isUserExpert(Yii::$app->user->identity['username'])) : ?>
                ...
                <div class="hypothesis_buttons_mobile">
                    ...
                    <?php elseif ($model->getEnableExpertise() === EnableExpertise::ON && ProjectCommunications::checkOfAccessToCarryingExpertise(Yii::$app->user->getId(), $model->getProjectId())) : ?>
                        ...
                        <?= Html::a('Экспертиза', ['/expertise/get-list', 'stage' => StageExpertise::getList()[StageExpertise::GCP], 'stageId' => $model->getId()], [
                            'class' => 'btn btn-default link-get-list-expertise',
                            'style' => [
                                'display' => 'flex',
                                'width' => '47%',
                    ...
                    <?php if ($model->confirm): ?>
                        ...
                        <?= Html::a('Работать далее', Url::to(['/confirm-gcp/view', 'id' => $model->confirm->getId()]), [
                            'class' => 'btn btn-default',
                            'style' => [
                                'display' => 'flex',
                                'width' => '47%',
