    ...
    <?php if ($model->getStatus() === User::STATUS_NOT_ACTIVE) : ?>
        ...
        <?php else : ?>
            ...
            <?php $form = ActiveForm::begin([
                'id' => 'formStatusUpdate',
                'action' => Url::to(['/admin/users/status-update', 'id' => $model->getId()]),
...
<?php elseif ($model->getRole() === User::ROLE_MANAGER) : ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'status', [
                    ...
                    'data' => [User::STATUS_ACTIVE => 'Активировать менеджера', User::STATUS_DELETED => 'Заблокировать менеджера'],
                    'options' => ['id' => 'selectStatusUpdate'],
                    'disabled' => false,  //Сделать поле неактивным
                    'hideSearch' => true, //Скрытие поиска
                ]) ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'status', [
                    ...
                    'data' => [User::STATUS_DELETED => 'Заблокировать менеджера'],
                    'options' => ['id' => 'selectStatusUpdate'],
                    'disabled' => false,  //Сделать поле неактивным
                    'hideSearch' => true, //Скрытие поиска
                ]) ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'status', [
                    ...
                    'data' => [User::STATUS_ACTIVE => 'Активировать менеджера'],
                    'options' => ['id' => 'selectStatusUpdate'],
                    'disabled' => false,  //Сделать поле неактивным
                    'hideSearch' => true, //Скрытие поиска
                ]) ?>
