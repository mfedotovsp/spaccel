                    ...
                    <div class="row" style="display:flex; align-items: center;">
                        <div class="col-md-6">
                            <?php if ($model->isReadyForCompletion()): ?>
                                <?= Html::a('Завершить', ['/admin/wish-list/complete', 'id' => $model->getId()], [
                        ...
                        <div class="col-md-6">
                            <?= Html::a(Html::img('/images/icons/icon_delete.png', ['style' => ['width' => '24px']]),['/admin/wish-list/delete', 'id' => $model->getId()], [
                                'class' => 'pull-right delete-wish-list',
                                'title' => 'Удалить',
                            ]) ?>
                            <?= Html::a(Html::img('/images/icons/update_warning_vector.png', ['style' => ['width' => '24px', 'margin-right' => '20px']]),['/admin/wish-list/update', 'id' => $model->getId()], [
                                'class' => 'pull-right',
                                'title' => 'Редактировать',
                            ]) ?>
                        </div>
