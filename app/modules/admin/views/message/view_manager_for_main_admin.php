...
/**
 * @var FormCreateMessageManager $formMessage
 * @var User $main_admin
 * @var User $manager
                ...
                <div class="containerForManagerConversations">
                    ...
                    <?php if ($managerConversations) : ?>
                        ...
                        <?php foreach ($managerConversations as $managerConversation) : ?>
                            ...
                            <?php if ($managerConversation->getManagerId() !== $manager->getId()) : ?>
                            ...
                            <?php else : ?>
                                ...
                                <div class="container-user_messages active-message" id="managerConversation-<?= $managerConversation->getId() ?>">
