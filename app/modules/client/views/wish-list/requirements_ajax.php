        ...
        <div class="row requirementsDataTable">
            ...
            <div class="col-md-1">
                <?= Html::a(Html::img('/images/icons/icon_update.png', ['style' => ['width' => '24px', 'margin-left' => '20px']]),
                    ['/client/wish-list/requirement-update', 'id' => $requirement->getId()], [
                        'title' => 'Редактировать',
                    ]) ?>
                <?= Html::a(Html::img('/images/icons/icon_delete.png', ['style' => ['width' => '24px']]),['/client/wish-list/requirement-delete', 'id' => $requirement->getId()], [
