    ...
    <div class="row container-fluid">
        ...
        <div class="col-md-12 containerClientCodes">
            ...
            <div class="row rowClientCode">
                ...
                <div class="col-md-4">
                    <?= Html::a( 'Сгенерировать новый код доступа',
                        Url::to(['/client/setting-codes/generation', 'type' => ClientCodeTypes::REGISTRATION_CODE_FOR_SIMPLE_USER]),[
            ...
            <div class="row rowClientCode">
                ...
                <div class="col-md-4">
                    <?= Html::a( 'Сгенерировать новый код доступа',
                        Url::to(['/client/setting-codes/generation', 'type' => ClientCodeTypes::REGISTRATION_CODE_FOR_TRACKER]),[
                            'class' => 'btn btn-default',
                            'style' => [
                                'display' => 'flex',
                                'align-items' => 'center',
            ...
            <div class="row rowClientCode">
                ...
                <div class="col-md-4">
                    <?= Html::a( 'Сгенерировать новый код доступа',
                        Url::to(['/client/setting-codes/generation', 'type' => ClientCodeTypes::REGISTRATION_CODE_FOR_EXPERT]),[
                            'class' => 'btn btn-default',
                            'style' => [
                                'display' => 'flex',
                                'align-items' => 'center',
            ...
            <div class="row rowClientCode">
                ...
                <div class="col-md-4">
                    <?= Html::a( 'Сгенерировать новый код доступа',
                        Url::to(['/client/setting-codes/generation', 'type' => ClientCodeTypes::REGISTRATION_CODE_FOR_CONTRACTOR]),[
                            'class' => 'btn btn-default',
                            'style' => [
                                'display' => 'flex',
                                'align-items' => 'center',
