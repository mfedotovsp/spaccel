                    ...
                    <?php if ($allConversations) : ?>
                        ...
                        <?php foreach ($allConversations as $conversation) : ?>
                            ...
                            <?php elseif (User::isUserExpert($conversation->user->getUsername())) : ?>
                                ...
                                <?php if ($conversation->getUserId() !== $expert->getId()) : ?>
                ...
                <?php if ($messages) : ?>
                    ...
                    <div class="create-message">
                        ...
                        $form = ActiveForm::begin([
                            ...
                            'action' => Url::to(['/expert/message/send-message-development', 'id' => Yii::$app->request->get('id')]),
...
<?php $this->registerJsFile('@web/js/expert_message_technical_suport_development.js'); ?>
<?php $this->registerJsFile('@web/js/form_message_expert_development.js'); ?>
