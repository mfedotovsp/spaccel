        ...
        <div class="row message_menu">
            ...
            <div class="col-sm-6 col-lg-4 search-block">
                ...
                $form = ActiveForm::begin([
                    ...
                    'action' => Url::to(['/' . $module . '/message/get-conversation-query', 'id' => $admin->getId()]),
                    ...
                    <div class="containerForExpertConversations">
                        ...
                        <?php if ($expertConversations) : ?>
                            ...
                            <?php foreach ($expertConversations as $conversation) : ?>
                                ...
                                <?php if ($conversation->getExpertId() === $expert->id) : ?>
                                    ...
                                    <div class="container-user_messages active-message" id="expertConversation-<?= $conversation->getId() ?>">
                                        ...
                                        <?php if ($conversation->user->getCountUnreadMessagesExpertFromUser($conversation->getExpertId())) : ?>
                                            <div class="countUnreadMessagesSender active"><?= $conversation->user->getCountUnreadMessagesExpertFromUser($conversation->getExpertId()) ?></div>
                                        <?php else : ?>
                                            <div class="countUnreadMessagesSender"></div>
                                        <?php endif; ?>
...
<?php else : ?>
    <?php $this->registerJsFile('@web/js/expert_message_view_client_admin.js'); ?>
<?php endif; ?>
