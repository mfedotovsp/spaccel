                ...
                <div class="containerAdminMainConversation">
                    ...
                    <div class="container-user_messages" id="adminMainConversation-<?= $conversationAdminMain->getId() ?>">
                        ...
                        <?php if ($main_admin->getAvatarImage()) : ?>
                            <?= Html::img('@web/upload/user-'.$main_admin->getId().'/avatar/'.$main_admin->getAvatarImage(), ['class' => 'user_picture']) ?>
                        <?php else : ?>
                        ...
                        <?php if ($main_admin->checkOnline === true) : ?>
...
<?php $this->registerJsFile('@web/js/expert_message_technical_suport_expert.js'); ?>
