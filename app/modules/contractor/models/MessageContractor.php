...
/**
 * Класс, который хранит сообщения из бесед исполнителей со всеми доступными пользователями, кроме техподдержки
 *
 * Class MessageContractor
 ...
 *
 * @property ConversationContractor $conversation               Беседа
 ...
 */
class MessageContractor extends ActiveRecord
{
    ...
    {
        return $this->hasOne(ConversationContractor::class, ['id' => 'conversation_id']);
    }
    ...
    {
        return MessageFiles::findAll(['category' => MessageFiles::CATEGORY_CONTRACTOR, 'message_id' => $this->id]);
    }
