...
/**
 * Форма создания сообщения между исполнителем и другими пользователями
 *
 * Class FormCreateMessageContractor
 * @package app\modules\contractor\models\form
 *
 ...
 */
class FormCreateMessageContractor extends Model
{
    ...
    public $category = MessageFiles::CATEGORY_CONTRACTOR;
    public $message_id;
    public $server_file;
     ...
     * @throws Exception
     */
    public function create(): MessageContractor
    {
        $model = new MessageContractor();
