...
$this->registerCssFile('@web/css/confirm-segment-task-marketing.css');
    ...
    <div class="row">
        ...
        <div class="container-fluid container-data">
            ...
            <div class="row row_header_data top_slide_pagination_responds">
                ...
                <div class="col-md-12" style="display: flex; padding: 5px 0 0 0;">
...
<?php
$this->registerJsFile('@web/js/confirm_segment_task_marketing.js');
?>
