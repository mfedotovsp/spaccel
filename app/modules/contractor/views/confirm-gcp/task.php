...
<div class="confirm-hypothesis-view-mobile">
    ...
    <div class="confirm-stage-mobile confirm-hypothesis-step-three-mobile">
        ...
        <div class="row row_header_data_generation_mobile mt-10">
            <div class="col-xs-8">
                <?php if (User::isUserContractor(Yii::$app->user->identity['username']) && !$gcp->getDeletedAt() && $gcp->getExistConfirm() === StatusConfirmHypothesis::MISSING_OR_INCOMPLETE && in_array($task->getStatus(), [ContractorTasks::TASK_STATUS_NEW, ContractorTasks::TASK_STATUS_PROCESS, ContractorTasks::TASK_STATUS_RETURNED], true)) : ?>
