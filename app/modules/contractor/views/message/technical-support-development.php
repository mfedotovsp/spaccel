                    ...
                    <?php if ($allConversations) : ?>
                        ...
                        <?php foreach ($allConversations as $conversation) : ?>
                            ...
                            <?php if (User::isUserSimple($conversation->user->getUsername())) : ?>
                                ...
                                <div class="container-user_messages" id="conversation-<?= $conversation->getId() ?>">
                                    ...
                                    <?php if ($conversation->user->getAvatarImage()) : ?>
                                        <?= Html::img('@web/upload/user-'.$conversation->user->getId().'/avatar/'.$conversation->user->getAvatarImage(), ['class' => 'user_picture']) ?>
                                    <?php else : ?>
                                        ...
                                        <?php if ($conversation->lastMessage) : ?>
                                            <div class="block_bottom_exist_message">
                                                ...
                                                <?php if ($conversation->lastMessage->sender->getAvatarImage()) : ?>
                                                    <?= Html::img('@web/upload/user-'.$conversation->lastMessage->sender->getId().'/avatar/'.$conversation->lastMessage->sender->getAvatarImage(), ['class' => 'icon_sender_last_message']) ?>
                                                <?php else : ?>
                            ...
                            <?php elseif (User::isUserContractor($conversation->user->getUsername())) : ?>
                                ...
                                <?php if ($conversation->getUserId() !== $contractor->getId()) : ?>
                ...
                <?php if ($messages) : ?>
                    ...
                    <div class="data-chat" id="data-chat">
                        ...
                        <?php foreach ($messages as $i => $message) : ?>
                            ...
                            <?php if ($message->getSenderId() !== $contractor->getId()) : ?>
                    ...
                    <div class="create-message">
                        ...
                        $form = ActiveForm::begin([
                            ...
                            'action' => Url::to(['/contractor/message/send-message-development', 'id' => Yii::$app->request->get('id')]),
...
<?php $this->registerJsFile('@web/js/contractor_message_technical_suport_development.js'); ?>
<?php $this->registerJsFile('@web/js/form_message_contractor_development.js'); ?>
