...
<?php $form = ActiveForm::begin([
    ...
    'action' => Url::to(['/contractor/segments/get-list-requirements', 'taskId' => $taskId]),
...
<div class="row container-fluid buttonsFiltersForListRequirements mb-5">
    <div class="col-md-4">
        <?= Html::a('Сбросить фильтры', Url::to(['/contractor/segments/get-list-requirements', 'taskId' => $taskId]), [
        ...
        <div class="row container-one_requirement">
            ...
            <div class="col-md-12">
                <div class="row details-requirement">
                    ...
                    <div class="col-md-12">
                        <?= Html::a('Выбрать запрос', ['/contractor/segments/get-hypothesis-to-create', 'id' => $taskId, 'useWishList' => true, 'requirementId' => $requirement->getId()], [
