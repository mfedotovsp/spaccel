...
/**
 * @var ContractorTaskSimilarProducts[] $models
 * @var bool $allowEdit
 * @var bool $isMobile
...
<div class="similar-product-list">
    ...
    <?php if (count($models) < 1): ?>
        ...
        <div class="text-center mt-15 font-size-18">Отсутствуют добавленные аналоги</div>
    ...
    <?php else: ?>
        ...
        <?php foreach ($models as $key => $model): ?>
            ...
            <?php if (!$isMobile): ?>
                ...
                <div class="row container-one_similar_product" id="taskSimilarProduct-<?= $model->getId() ?>" style="margin: 3px 0; padding: 0;">
                    <div class="col-md-11" title="Смотреть описание аналога">
                    ...
                    <div class="col-md-1" style="text-align: right;">
                        ...
                        <?php if ($allowEdit) {
                            ...
                            echo Html::a(Html::img('/images/icons/update_warning_vector.png', ['style' => ['width' => '24px', 'margin-right' => '20px']]),
                                Url::to(['/contractor/products/get-data-update-similar-product-form', 'id' => $model->getId()]), [
                                    'id' => 'taskProduct_form-' . $model->getId(),
                                    'class' => 'showTaskSimilarProductUpdateForm',
                                    'title' => 'Редактировать',
                                ]);

                            echo Html::a(Html::img('/images/icons/icon_delete.png', ['style' => ['width' => '24px']]),
                                Url::to(['/contractor/products/delete-similar-product', 'id' => $model->getId()]), [
                                    'id' => 'link_task_product_delete-' . $model->getId(),
                                    'class' => 'showDeleteTaskSimilarProductModal',
                                    'title' => 'Удалить',
                                ]);
                        } ?>
                ...
                <div class="row container-one_similar_product_desc taskSimilarProduct-<?= $model->getId() ?>">

                    <?php foreach ($productParams as $keyParam => $param): ?>

                        <div class="col-md-12">
                            <div class="bolder"><?= $param ?>:</div>
                            <div><?= $model->getParams()[$keyParam] ?></div>
                        </div>

                    <?php endforeach; ?>

                    <div class="col-md-12 mt-15">
                        <span class="bolder">Стоимость владения:</span>
                        <span><?= $model->getOwnershipCost() ?> руб.</span>
                    </div>
                        ...
                        <div class="hypothesis_buttons_mobile">
                            ...
                            <?php if ($allowEdit): ?>
                                ...
                                <?= Html::a('Редактировать',
                                    Url::to(['/contractor/products/get-data-update-similar-product-form', 'id' => $model->getId()]), [
                                        'id' => 'taskProduct_form-' . $model->getId(),
                                        'class' => 'btn btn-default showTaskSimilarProductUpdateForm',
                                        'style' => [
                                            'display' => 'flex',
                                            'width' => '47%',
                                            'height' => '36px',
                                ...
                                <?= Html::a('Удалить аналог',
                                    Url::to(['/contractor/products/delete-similar-product', 'id' => $model->getId()]), [
                                        'id' => 'link_task_product_delete-' . $model->getId(),
                                        'class' => 'btn btn-default showDeleteTaskSimilarProductModal',
                                        'style' => [
                                            'display' => 'flex',
                                            'width' => '47%',
                                            'height' => '36px',
    ...
    if ($allowEdit && !$isMobile && count($task->products) > 0): ?>
