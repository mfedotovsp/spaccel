        ...
        <div class="container-fluid container-data">
            ...
            <div class="row" style="margin: 5px 15px 0 15px; padding: 10px; border-bottom: 1px solid #ccc;">
                ...
                <div class="row mt-10">
                    <div class="col-md-12">
                    <span class="task-header">
                        Исходные данные подтверждения проблемы
                    </span>
                    <span class="pl-5">
                        <?= Html::a(Html::img('/images/icons/icon_view.png', ['style' => ['width' => '28px', 'margin-right' => '20px', 'margin-bottom' => '5px']]),
                            ['/contractor/confirm-problem/show-data-confirm-hypothesis', 'id' => $task->getId()], [
                                'class' => 'openDataConfirmHypothesis', 'title' => 'Смотреть исходные данные подтверждения проблемы',
                            ]) ?>
                    </span>
                    </div>
                </div>
...
<div class="confirm-hypothesis-view-mobile">
    ...
    <div class="project-menu-mobile">
        <div class="project_buttons_mobile flex-column">
            ...
            <?= Html::a('Данные подтверждения', ['/contractor/confirm-problem/show-data-confirm-hypothesis', 'id' => $task->getId()], [
    ...
    <div class="arrow_links_router_mobile">
        ...
        <div class="text-stage">4/9. Подтверждение гипотез проблем сегмента</div>
    ...
    <div class="confirm-stage-mobile confirm-hypothesis-step-three-mobile">
        ...
        <div class="row row_header_data_generation_mobile mt-10">
            <div class="col-xs-8">
                <?php if (User::isUserContractor(Yii::$app->user->identity['username']) && !$problem->getDeletedAt() && $problem->getExistConfirm() === StatusConfirmHypothesis::MISSING_OR_INCOMPLETE && in_array($task->getStatus(), [ContractorTasks::TASK_STATUS_NEW, ContractorTasks::TASK_STATUS_PROCESS, ContractorTasks::TASK_STATUS_RETURNED], true)) : ?>
