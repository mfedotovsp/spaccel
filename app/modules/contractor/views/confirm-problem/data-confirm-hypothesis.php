...
<div class="block_export_link_hypothesis">
    ...
    <?= Html::a('<div style="margin-top: -15px;">Исходные данные подтверждения проблемы' . '</div>', ['#'], [
...
<div class="row container-fluid" style="color: #4F4F4F;">
    ...
    <div class="row">
        <div class="col-md-12 bolder">Какую потребность потребителя сегмента проверяем</div>
    ...
    <?php if ($isTaskMarketing): ?>
        ...
        <div class="row">
            <div class="col-md-12 bolder">Количество респондентов (представителей сегмента):
                <span style="font-weight: 400;"><?= $model->getCountRespond() ?></span>
            </div>
        </div>

        <div class="row">
            <div class="col-md-12 bolder">Необходимое количество респондентов, подтверждающих проблему:
