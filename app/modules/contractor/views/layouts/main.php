    ...
    <div class="shared-container" id="simplebar-shared-container">
        ...
        <div class="wrap" id="identifying_recipient_new_message-<?= $user->getId() ?>">
            ...
            <div class="nav-bar-menu-desktop">
                ...
                <?php
                NavBar::begin([
                    'id' => 'main_menu_contractor',
                    'brandLabel' => Yii::$app->name = 'Spaccel <span style="font-size: 13px;font-weight: 700;border-bottom: 1px solid #c0c0c0;">contractor-panel</span>',
                    'brandUrl' => ['/contractor/default/index'],
                ...
                echo Nav::widget([
                    ...
                    'items' => [
                        ...
                        ['label' => $user->countUnreadCommunications ? '<div class="countUnreadCommunications active">' . $user->countUnreadCommunications . '</div>' . Html::img('/images/icons/icon_notification_bell.png', ['class' => 'icon_messager', 'title' => 'Уведомления'])
                            : '<div class="countUnreadCommunications"></div>' . Html::img('/images/icons/icon_notification_bell.png', ['class' => 'icon_messager', 'title' => 'Уведомления']), 'url' => ['/contractor/communications/notifications', 'id' => $user->getId()]],

                        ['label' => Html::img('/images/icons/projects_icon.png', ['class' => 'icon_messager', 'title' => 'Проекты']), 'url' => ['/contractor/projects/index', 'id' => $user->getId()]],
                        ...
                        [
                            ...
                            'items' => [
                                ['label' => 'Мой профиль', 'url' => Url::to(['/contractor/profile/index', 'id' => $user->getId()])],
